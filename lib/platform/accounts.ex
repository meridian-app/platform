defmodule Platform.Accounts do
  ...
  alias Platform.Accounts.{Users, UsersToken, UsersNotifier}
  ...
  ## Examples
      ...
      iex> deliver_users_update_email_instructions(users, current_email, &url(~p"/identity/settings/confirm_email/#{&1}"))
      {:ok, %{to: ..., body: ...}}
  ...
  ## Examples
      ...
      iex> deliver_users_confirmation_instructions(users, &url(~p"/identity/confirm/#{&1}"))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_users_confirmation_instructions(confirmed_users, &url(~p"/identity/confirm/#{&1}"))
  ...
  ## Examples
      ...
      iex> deliver_users_reset_password_instructions(users, &url(~p"/identity/reset_password/#{&1}"))
      {:ok, %{to: ..., body: ...}}
