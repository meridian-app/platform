defmodule PlatformWeb.UsersAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_platform_web_users_remember_me"
  ...
  the current_users:
      ...
      defmodule PlatformWeb.PageLive do
        use PlatformWeb, :live_view

        on_mount {PlatformWeb.UsersAuth, :mount_current_users}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{PlatformWeb.UsersAuth, :ensure_authenticated}] do
  ...
  def on_mount(:ensure_authenticated, _params, session, socket) do
    ...
    if socket.assigns.current_users do
      ...
      socket =
        ...
        |> Phoenix.LiveView.redirect(to: ~p"/identity/login")
