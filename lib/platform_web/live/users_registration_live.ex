defmodule PlatformWeb.UsersRegistrationLive do
  use PlatformWeb, :live_view

  alias Platform.Accounts
  alias Platform.Accounts.Users
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      <.header class="text-center">
        ...
        <:subtitle>
          Already registered?
          <.link navigate={~p"/identity/login"} class="font-semibold text-brand hover:underline">
            Log in
          </.link>
          to your account now.
        </:subtitle>
      ...
      <.simple_form
        ...
        action={~p"/identity/login?_action=registered"}
        method="post"
      >
